...
urlpatterns = [
    ...
    path("delete_course/<int:course_id>", views.delete_course.as_view(), name="delete_course"),
    ...
    path("delete_topic/<int:topic_id>", views.delete_topic.as_view(), name="delete_topic"),
